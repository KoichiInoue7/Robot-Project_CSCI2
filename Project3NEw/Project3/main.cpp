...
#ifdef _P_EXTRA_CREDIT_

		// If you did the extra credit and hence have a history.cpp and .h
		// place #include _P_EXTRA_CREDIT_ at the top of your main.cpp to
		// run this test

		ostringstream oss;
		streambuf_switcher ssout(cout, oss);
		Arena a(2, 2);
		a.addPlayer(1, 1);
		a.player()->move(RIGHT);
		a.player()->stand();
